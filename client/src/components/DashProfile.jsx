...
export default function DashProfile() {
        ...
        uploadTask.on(
            ...
            (snapshot) => {
                const progress = 
                    ...
                    setImageFileUploadFileProgress(progress.toFixed(0));
            },
            (error) => {
                setImageFileUploadFileError('Could not upload image (File must be less than 2MB)');
    ...
    try{
        ...
        if(!res.ok){
            ...
            setUpdateUserSuccess("User'sprofile updated successfully")
        }
    }catch(error){
